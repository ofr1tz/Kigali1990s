...
L.Control.higherOpacity = L.Control.extend({
    ...
    onAdd: function () {
		...
		higher_opacity_div.title = "Increase opacity" // tooltip added (of)
...
L.Control.lowerOpacity = L.Control.extend({
    ...
    onAdd: function (map) {
		...
		lower_opacity_div.title = "Decrease opacity" // tooltip added (of)
...
L.Control.opacitySlider = L.Control.extend({
    ...
    onAdd: function (map) {
		...
		opacity_slider_div.title = "Opacity slider" // tooltip added (of)
